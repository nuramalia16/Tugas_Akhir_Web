...
<body  style="background-color: #F5E8B7;">
    ...
    <nav class="navbar navbar-expand-lg pt-4 pb-4" style="background-color: #CD5C08; color:beige;">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ps-4">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="/driver">Driver</a></li>
                        </ul>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary"  style="background-color: #3D0C11;">
        <div class="container-fluid">
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" style="color:beige;" aria-current="page" href="/log">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" style="color:beige;" href="/allcar">Car</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" style="color:beige;" href="/dr">Driver</a>
              </li>
              {{-- <li class="nav-item">
                <a class="nav-link" style="color:beige;" href="/">Log out</a>
            </li> --}}
            <li class="nav-item active">
                <a class="nav-link" onclick="document.getElementById('logout-form').submit()" href="#" style="color: beige;">
